                ...
                <div className="relative flex gap-6">
                  ...
                  <div className="flex-1 relative pb-16">
                    ...
                    <div className="relative h-80">
                      {/* Bars Only Container */}
                      <div className="absolute inset-0 flex justify-around px-4 gap-8 pointer-events-none">
                        {data.map((d) => (
                          <div
                            key={d.period_start}
                            className="h-full flex items-end justify-center"
                            style={{ width: `${Math.min(80, 600 / data.length)}px` }}
                          >
                            {/* Bar */}
                            <div
                      ...
                      {/* Labels Below Chart */}
                      <div className="absolute left-0 right-0 flex justify-around px-4 gap-8" style={{ top: '320px' }}>
                        {data.map((d) => (
                          <div
