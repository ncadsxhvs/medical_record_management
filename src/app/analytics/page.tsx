...
export default function AnalyticsPage() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `rvu-export-${startDate}-to-${endDate}.xlsx`;
      a.click();
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-7 gap-4">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            <button
              ...
              disabled={exporting}
              className="px-3.5 py-1.5 text-xs font-semibold rounded-full border border-zinc-200 bg-white text-zinc-700 hover:bg-zinc-50 active:scale-[0.98] transition-colors cursor-pointer disabled:opacity-50 flex items-center gap-1"
            >
